...
namespace RT64 {
    ...
    struct RSPProcessDescriptorSet : RenderDescriptorSetBase {
        ...
        RSPProcessDescriptorSet(RenderDevice *device = nullptr) {
            ...
            srcTcVel = builder.addFormattedBuffer(4);
            srcCol = builder.addFormattedBuffer(5);
            srcNorm = builder.addFormattedBuffer(6);
            srcViewProjIndices = builder.addFormattedBuffer(7);
            srcWorldIndices = builder.addFormattedBuffer(8);
            srcFogIndices = builder.addFormattedBuffer(9);
            srcLightIndices = builder.addFormattedBuffer(10);
            srcLightCounts = builder.addFormattedBuffer(11);
            srcLookAtIndices = builder.addFormattedBuffer(12);
            rspViewportVector = builder.addStructuredBuffer(13);
            rspFogVector = builder.addStructuredBuffer(14);
            rspLightVector = builder.addStructuredBuffer(15);
            rspLookAtVector = builder.addStructuredBuffer(16);
            viewProjTransforms = builder.addStructuredBuffer(17);
            worldTransforms = builder.addStructuredBuffer(18);
            dstPos = builder.addReadWriteStructuredBuffer(19);
            dstTc = builder.addReadWriteStructuredBuffer(20);
            dstCol = builder.addReadWriteStructuredBuffer(21);
            builder.end();
